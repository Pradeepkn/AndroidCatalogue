...
public class GoldItems implements Serializable {
	/**
	 * 
	 */
	//Every serializable class is assigned a version identifier called a serialVersionUID.
	...
	public GoldItems(String name, String jewelleryType, String gender,
