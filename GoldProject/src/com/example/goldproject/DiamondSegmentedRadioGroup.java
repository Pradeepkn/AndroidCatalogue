...
public class DiamondSegmentedRadioGroup extends RadioGroup{

	public DiamondSegmentedRadioGroup(Context context) {

		super(context);
	}

	public DiamondSegmentedRadioGroup(Context context, AttributeSet attrs) {
