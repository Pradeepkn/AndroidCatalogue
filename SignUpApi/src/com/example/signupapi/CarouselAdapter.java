...
public class CarouselAdapter extends BaseAdapter{
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		/*mImage.setImageResource(R.drawable.banner1);
		mImage.setImageResource(R.drawable.banner2);
		mImage.setImageResource(R.drawable.banner3);
		mImage.setImageResource(R.drawable.banner4);
		mImage.setImageResource(R.drawable.banner5);
		mImage.setImageResource(R.drawable.banner6);*/
