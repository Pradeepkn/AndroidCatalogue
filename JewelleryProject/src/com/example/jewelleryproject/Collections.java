...
public class Collections {
	...
	public Collections(String item_type, String purity, String image_path,
			String price, String occassion, String weight,
			String making_charge, String wastage, String model) {
		super();
